...
class DPCNNModel(BaseModel):
    ...
    def attach_privacy_engine(self, opacus_params):
    ...
    def fit(self, train_loader, test_loader, epochs, epsilon, delta, max_grad_norm, secure_mode,):
        raise NotImplementedError
    ...
    def compute_test_metrics(self, args):
        raise NotImplementedError
