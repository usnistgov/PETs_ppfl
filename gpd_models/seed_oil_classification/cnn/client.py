...
def init_model(learning_rate, weight_decay, num_data_features):
...
def train_partition(
    ...
    return (train_acc_epochs, test_acc_epochs, losses_epochs)
...
class FlowerClient(fl.client.NumPyClient):
    def __init__(
        ...
        self.model, self.criterion, self.optimizer = init_model(
            self.learning_rate, self.weight_decay, self.num_data_features
        )
    ...
    def fit(self, parameters, config):
        ...
        (train_acc_epochs, test_acc_epochs, losses_epochs) = train_partition(
            self.client_id,
            self.model,
            self.optimizer,
            self.criterion,
        ...
        save_client(
            ...
            per_epoch_metrics={
                ...
                "eps_spent": getattr(self, "eps_spent_epochs", []),  # Optional
            },
    ...
    def evaluate(self, parameters, config):
        ...
        (train_acc, test_acc, train_loss, test_loss, label_counts) = eval_cnn(
            self.client_id,
            self.train_loader,
            self.test_loader,
            self.model,
