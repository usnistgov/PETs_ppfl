...
def get_evaluate_fn(
    ...
    def evaluate_fn(server_round: int, parameters, config):
        ...
        print('GLOBAL ACCURACY:', accuracy, 'SERVER ROUND:', server_round)
        ...
        if server_round == num_rounds:
            ...
            np.savez(
                Path(outpath, "dpcnn_oil_global_metadata.npz"), **metadata
            )
            torch.save(
                model.state_dict(), Path(outpath, "dpcnn_oil_global.torch")
            )
